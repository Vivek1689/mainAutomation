...
public class ExtentLogger {
    ...
    public static void attachLogo(){
        ...
        htmlReporter.config().setCss(".brand-logo { background-image: url('spark/logo.png'); }");
       // if(Objects.nonNull(ExtentCucumberAdapter.getCurrentScenario())) ExtentCucumberAdapter.get;
    }
